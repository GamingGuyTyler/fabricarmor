...
import net.ggtylerr.fabricarmor.FabricArmor;
...
public enum CustomArmor implements ArmorMaterial {
    FABRIC("leather", 5, new int[]{1, 4, 5, 2}, 15, SoundEvents.ITEM_ARMOR_EQUIP_LEATHER, 0.0F, () -> {
    ...
    private CustomArmor(String string_1, int int_1, int[] ints_1, int int_2, SoundEvent soundEvent_1, float float_1, Supplier<Ingredient> supplier_1) {
        this.name = string_1;
